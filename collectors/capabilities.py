...
MANIFESTS = {
    ...
    "fortigate": (
        ...
        _cap("firewall_health", "Firewall health", measurements=("firewall",),
             services=("Security",)),
        _cap("interfaces", "Interface inventory", measurements=("interface",),
             services=("Internet",)),
        _cap("wan_classification", "Authoritative WAN classification", "conditional",
             measurements=("interface",), services=("Internet",),
             condition="At least one discovered interface is explicitly selected as WAN."),
        _cap("performance", "Resource performance", measurements=("performance",)),
        _cap("ha_status", "HA status", "conditional", measurements=("firewall",),
             condition="The FortiOS HA monitor endpoint is available."),
        _cap("sdwan", "SD-WAN membership", "conditional",
             condition="The configured FortiOS endpoint returns SD-WAN membership."),
        _cap("vpn", "VPN health", "unsupported",
             reason="The current read-only collector does not collect VPN state."),
        _cap("collector_diagnostics", "Collector diagnostics",
             measurements=("collector_health",), services=("Monitoring",)),
    ),
    "papercut": (
        ...
        _cap("server_health", "Application server health",
             measurements=("availability", "performance"),
             services=("Printing",), panels=("Overall Health", "Database")),
        ...
        _cap("device_inventory", "Embedded device inventory", "conditional",
             measurements=("device",), services=("Printing",), panels=("Devices",),
             condition="The System Health API returns embedded-device records."),
        _cap("printer_operational_status", "Printer operational status", "conditional",
             measurements=("device",), services=("Printing",), panels=("Printers",),
             condition="The /api/health/printers endpoint returns per-printer status records."),
        _cap("print_queue_health", "Print queue health", "conditional",
             measurements=("device", "performance"),
             fields=("operational_status", "held_jobs"),
             services=("Printing",), panels=("Printers",),
             condition="The /api/health/printers endpoint returns queue status and held-job evidence."),
        ...
        _cap("printer_consumables", "Printer consumables", "unsupported",
             ...
             reason="PaperCut System Health does not expose toner percentages or consumable levels."),
        _cap("collector_diagnostics", "Collector diagnostics",
             measurements=("collector_health",), services=("Monitoring",),
             panels=("Collector Diagnostics",)),
    ),
